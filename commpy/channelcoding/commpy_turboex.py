...
iterations_number = 100000/k# Number of blocks for testing # (iter_num=1000, k = 1000, SNR_points = 10: 3 hours)
...
for iterations in range(iterations_number):
    ...
    for idx in range(len(test_sigmas)):
        ...
        decoded_bits = turbo.turbo_decode(sys_r, par1_r, par2_r, trellis1, test_sigmas[idx]**2, 6, interleaver, L_int = None)
...
print(nb_errors/float(k*iterations_number))   
print('BLER: ')
print(1-nb_block_no_errors/float(iterations_number))
